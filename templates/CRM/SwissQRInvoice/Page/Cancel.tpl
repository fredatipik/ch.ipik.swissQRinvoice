...
<div class="crm-block crm-content-block">
  <div class="messages warning">
    ...
    <span class="description">Cette action est irréversible. La facture passera au statut <em>{ts}Cancelled{/ts}</em> et ne pourra plus être envoyée ni marquée comme payée.</span>
  </div>
